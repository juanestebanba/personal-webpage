...
class ElementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create element" do
    assert_difference('Element.count') do
      post elements_url, params: { element: { book_id: @element.book_id, content_text: @element.content_text, element_type: @element.element_type, position: @element.position } }
    end
  ...
  test "should update element" do
    patch element_url(@element), params: { element: { book_id: @element.book_id, content_text: @element.content_text, element_type: @element.element_type, position: @element.position } }
